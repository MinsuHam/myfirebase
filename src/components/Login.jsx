    ...
    <Container>
       <Row className="justify-content-md-center mt-5">
          <Col>
             ...
             <Form onSubmit={login}
                   className="justify-content-center mt-5 mx-auto" 
                   style={{              
                      maxWidth:'400px', 
             ...
             <p className="mx-auto text-end pt-3"
             style={{              
                      maxWidth:'400px', 
                      padding:"0 40px"
                    }}>
       ...
       <div className="d-flex justify-content-md-center mt-1 mx-auto" 
            style={{
               maxWidth:"400px",
          ...
          <div style={{
               width:"63px",
               height:"50px",
               background:"url(images/google_logo.png) no-repeat 10px center",
               backgroundSize:"40px"
            }}>             
          </div>
          <div onMouseEnter={()=>setHover(true)}
               onMouseLeave={()=>setHover(false)}
               style={{...mystyle.normal, ...(hover? mystyle.hover : null)}}
